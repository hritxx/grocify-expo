...
export default function SignInScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-primary" edges={["top"]}>
      ...
      <View className="absolute -right-[-74px] top-40 h-72 w-72 rounded-full bg-primary/70 dark:bg-secondary/35" />
      <View className="px-4 pt-4">
        ...
        <View className="mt-6 rounded-[30px] border border-white/20 bg-white/10 px-3">
          <Image
      ...
      <View className="mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6">
        ...
        <View className="mt-6">
          ...
          >
            <View className="h-8 w-8 items-center justify-center rounded-full bg-white">
              <FontAwesome name="apple" size={18} color="#5F6e66" />
            </View>
            <Text className="ml-3 flex-1 text-lg font-semibold text-card-foreground">
              {isGoogleClicked
                ? "Connecting to Apple..."
          ...
          >
            <View className="h-8 w-8 items-center justify-center rounded-full bg-white">
              <FontAwesome name="github" size={18} color="#5f6e66" />
            </View>
            <Text className="ml-3 flex-1 text-lg font-semibold text-card-foreground">
              {isGoogleClicked
